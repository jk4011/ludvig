...
class OptimizationParams(ParamGroup):
    def __init__(self, parser, max_steps=30_000, lr_scaler=1, lr_final_scaler=1, color_lr_scaler=1, opacity_lr_scaler=1, scaling_lr_scaler=1, rotation_lr_scaler=1,  ):
